    ...
    for row=rmax:-1:1
        ...
        if row < rmax
            if j==1
                ...
                [C,index]=min(tmp);
                if index==1
                    I(row+1,j,1)=I(row+1,i,1);
            I(row+1,i,1)=I(row+1,i+1,1);
                    I(row+1,j,2)=0;
                    I(row+1,j,3)=0;
                end
                if index==2
                    I(row+1,j+1,1)=I(row+1,i+1,1);
            I(row+1,i+1,1)=I(row+1,i+2,1);
                    I(row+1,j+1,2)=0;
                    I(row+1,j+1,3)=0;
                    j=j+1;
                end
